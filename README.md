...
## Step 1: Install Pods and Start the Metro Server
...
To check if your computer detects Android device, type `adb devices` and you should see your phone and its ID
